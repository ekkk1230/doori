                ...
                <div className="gless-card mt-[2rem]">
                    ...
                    <ul className="space-y-[1.6rem]">
                        {MOCK_BUDGET_SUMMARY.map(item => {
                            ...
                            return (
                                <li key={item.id} className="flex items-center text-[1.4rem] gap-[1rem]">
                ...
                <div className="gless-card mt-[2rem] relative">
                    ...
                    <ul className="space-y-[.8rem]">
                        {upcomingTasks.slice(0, 3).map(item => {
                            ...
                            return (
                                <li key={item.id} className="flex text-[1.2rem] p-[1rem_1.2rem] rounded-[1.2rem] bg-gray-200/20">
                                    <p className="tit mr-[1rem] text-rose-700">D-{remainingDate}</p>
                                    <p>{item.title}</p>
                                    <p className="ml-auto">{item.isEssential && "필수"}</p>
                                </li>
                            )
                        })}
                    </ul>
                    <Link href="/timeline" className="flex items-center text-[1.2rem] text-rose-800 absolute right-[2rem] top-[2rem]">전체 보기 <ChevronRight className="w-[1.4rem] h-[1.4rem]" /></Link>
                </div>
            </div>
